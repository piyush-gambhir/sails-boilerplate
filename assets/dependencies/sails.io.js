    ...
    return (function (a) {
            ...
            function e(a) {
                function c() {
                    if (c.enabled) {
                        ...
                        for (
                            var f = new Array(arguments.length), g = 0;
                            g < f.length;
                            g++
                        )
                            f[g] = arguments[g];
        ...
        function (a, b) {
            ...
            a.exports = function (a, b) {
                ...
                if ("number" === f && isNaN(a) === !1)
                    return b["long"] ? e(a) : d(a);
                throw new Error(
            ...
            (function (a) {
                ...
                (b.deconstructPacket = function (a) {
                    ...
                    (b.reconstructPacket = function (a, b) {
                        return (
                            (a.data = e(a.data, b)), (a.attachments = void 0), a
                        );
                    }),
        ...
        function (a, b, c) {
            ...
            (a.exports = d),
                ...
                (d.prototype.updateSocketIds = function () {
                    for (var a in this.nsps)
                        o.call(this.nsps, a) &&
                            (this.nsps[a].id = this.generateId(a));
                }),
                ...
                (d.prototype.onopen = function () {
                    ...
                    this.subs.push(j(a, "data", k(this, "ondata"))),
                        ...
                        this.subs.push(
                            j(this.decoder, "decoded", k(this, "ondecoded")),
                        );
                }),
            ...
            (function (b) {
                function d(a, c) {
                    ...
                    (c = c || {}),
                        ...
                        c.hostname &&
                            !c.port &&
                            (c.port = this.secure ? "443" : "80"),
                        (this.agent = c.agent || !1),
                        (this.hostname =
                            c.hostname ||
                            (b.location ? location.hostname : "localhost")),
                        (this.port =
                            c.port ||
                ...
                (a.exports = d),
                    ...
                    (d.prototype.createTransport = function (a) {
                        ...
                        var d = new f[a]({
                            ...
                            timestampRequests:
                                c.timestampRequests || this.timestampRequests,
                            timestampParam:
                                c.timestampParam || this.timestampParam,
                            ...
                            perMessageDeflate:
                                c.perMessageDeflate || this.perMessageDeflate,
                            ...
                            requestTimeout:
                                c.requestTimeout || this.requestTimeout,
                    ...
                    (d.prototype.onOpen = function () {
                        if (
                            ...
                            for (
                                var a = 0, b = this.upgrades.length;
                                a < b;
                                a++
                            )
                    ...
                    (d.prototype.onHeartbeat = function (a) {
                        ...
                        var b = this;
                        b.pingTimeoutTimer = setTimeout(
                            function () {
                                "closed" !== b.readyState &&
                                    b.onClose("ping timeout");
                            },
            ...
            (function (b) {
                ...
                function e(a) {
                    if (
                        ...
                        d || (d = c ? 443 : 80),
                            (this.xd =
                                a.hostname !== b.location.hostname ||
                                d !== a.port),
                            (this.xs = a.secure !== c);
                    }
                }
        ...
        function (a, b, c) {
            (function (a) {
                ...
                (b.encodePacket = function (b, c, f, h) {
                    ...
                    var i =
                        void 0 === b.data ? void 0 : b.data.buffer || b.data;
                    if (a.ArrayBuffer && i instanceof ArrayBuffer)
                        return e(b, c, h);
                    ...
                    (b.decodePayload = function (a, c, d) {
                        if ("string" != typeof a)
                            return b.decodePayloadAsBinary(a, c, d);
                        "function" == typeof c && ((d = c), (c = null));
                        var e;
                        if ("" === a) return d(u, 0, 1);
                        for (
                        ...
                        if (this.check()) {
                            ...
                            (c.pfx = this.pfx),
                                ...
                                (c.rejectUnauthorized =
                                    this.rejectUnauthorized),
                                this.extraHeaders &&
                                    (c.headers = this.extraHeaders),
                                this.localAddress &&
                                    (c.localAddress = this.localAddress);
                            try {
            ...
            g(d.prototype),
                ...
                (d.prototype.onevent = function (a) {
                    ...
                    k("emitting event %j", b),
                        null != a.id &&
                            (k("attaching ack callback to event"),
                ...
                (d.prototype.ack = function (a) {
                    ...
                    return function () {
                        if (!c) {
                            ...
                            var d = h(arguments);
                            k("sending ack %j", d),
                                b.packet({ type: f.ACK, id: a, data: d });
                        }
                    };
                }),
        ...
        function (a, b) {
            ...
            a.exports = function (a, b) {
                if (
                    ("string" == typeof b && (b = a[b]), "function" != typeof b)
                )
        ...
        function (a, b) {
            function c(a) {
                (a = a || {}),
                    ...
                    (this.jitter =
                        a.jitter > 0 && a.jitter <= 1 ? a.jitter : 0),
                    (this.attempts = 0);
            }
            (a.exports = c),
...
(function () {
    ...
    if (thisScriptTag) {
        ...
        CONFIGURABLE_VIA_HTML_ATTR.forEach(function (configKey) {
            scriptTagConfig[configKey] = (function () {
                ...
                var htmlAttrVal = thisScriptTag.getAttribute(
                    "data-" + configKey,
                );
                if (!htmlAttrVal) {
    ...
    function SailsIOClient(_providedSocketIO) {
        ...
        JWR.prototype.pipe = function () {
            ...
            return new Error(
                "Client-side streaming support not implemented yet.",
            );
        };
            ...
            socket._raw.emit(
                ...
                function serverResponded(responseCtx) {
                    ...
                    if (cb && !requestCtx.calledCb) {
                        ...
                        socket._responseCbs.splice(
                            socket._responseCbs.indexOf(cb),
                            1,
                        );
                ...
                Object.defineProperty(self, option, {
                    get: function () {
                        if (option == "url") {
                            return (
                                _opts[option] ||
                                (self._raw && self._raw.io && self._raw.io.uri)
                            );
                        }
                        return _opts[option];
                    },
        ...
        SailsSocket.prototype._connect = function () {
            ...
            if (typeof self.query === "string") {
                ...
                throw new Error(
                    "Unexpected data type provided for `query` setting: " +
                        self.query,
                );
            }
            ...
            var isXOrigin = (function () {
                ...
                var targetAfterProtocol = self.url.replace(
                    /^([a-z]+:\/\/)/i,
                    "",
                );
        ...
        SailsSocket.prototype.disconnect = function () {
            ...
            if (!this.isConnected()) {
                throw new Error(
                    "Cannot disconnect- socket is already disconnected",
                );
            }
        ...
        SailsSocket.prototype.off = function (evName, fn) {
            ...
            // Otherwise queue the event binding.
            if (
                this.eventQueue[evName] &&
                this.eventQueue[evName].indexOf(fn) > -1
            ) {
                this.eventQueue[evName].splice(
                    this.eventQueue[evName].indexOf(fn),
                    1,
                );
            }
        ...
        io.sails = {
            ...
            environment:
                urlThisScriptWasFetchedFrom.match(
                    /(\#production|\.min\.js)/g,
                ) ||
                (typeof window === "object" &&
                    window &&
